  ...
  <div class="add-update-project-container">
    ...
    <form @submit.prevent="submitForm">
      ...
      <div class="form-group">
        ...
        <textarea id="details" v-model="project.details" placeholder="Enter project details" @input="resizeTextarea"
          ref="detailsTextarea"></textarea>
      ...
      <div class="add-update-button-container">
        <button type="submit" class="add-update-button">{{ isEditMode ? 'Update Project' : 'Add Project' }}</button>
      </div>
    </form>
  </div>
</template>
